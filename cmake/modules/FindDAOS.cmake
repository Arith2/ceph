...
find_path(DAOS_S3_INCLUDE_DIR daos_s3.h
  HINTS ${PC_DAOS_INCLUDEDIR} ${PC_DAOS_INCLUDE_DIRS}
  PATHS /usr/local/include /usr/include)
...
find_library(DAOS_DS3_LIBRARY NAMES ds3
  HINTS ${PC_DAOS_LIBDIR} ${PC_DAOS_LIBRARY_DIRS}
  PATHS /usr/local/lib64 /usr/local/lib /usr/lib64 /usr/lib)
...
set(DAOS_INCLUDE_DIRS ${DAOS_INCLUDE_DIR} ${DAOS_FS_INCLUDE_DIR} ${DAOS_S3_INCLUDE_DIR})
set(DAOS_LIBRARIES ${DAOS_LIBRARY} ${DAOS_FS_LIBRARY} ${DAOS_DS3_LIBRARY} ${DAOS_UNS_LIBRARY})
...
find_package_handle_standard_args(DAOS DEFAULT_MSG
                                  DAOS_INCLUDE_DIR DAOS_FS_INCLUDE_DIR DAOS_S3_INCLUDE_DIR
                                  DAOS_LIBRARY DAOS_FS_LIBRARY DAOS_DS3_LIBRARY DAOS_UNS_LIBRARY)

mark_as_advanced(DAOS_INCLUDE_DIR DAOS_FS_INCLUDE_DIR DAOS_S3_INCLUDE_DIR
                 DAOS_LIBRARY DAOS_FS_LIBRARY DAOS_DS3_LIBRARY DAOS_UNS_LIBRARY)